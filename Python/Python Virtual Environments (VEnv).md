A virtual environment in Python is nothing more than a directory (folder). It is most common to create the virtual environment inside your project folder alongside all your source code.
